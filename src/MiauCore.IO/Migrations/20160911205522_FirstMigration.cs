    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientReward", x => new { x.ClientId, x.RewardId });
                    table.ForeignKey(
                        name: "FK_ClientReward_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientReward_Rewards_RewardId",
                        column: x => x.RewardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvestorReward", x => new { x.InvestorId, x.RewardId });
                    table.ForeignKey(
                        name: "FK_InvestorReward_Investors_InvestorId",
                        column: x => x.InvestorId,
                        principalTable: "Investors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvestorReward_Rewards_RewardId",
                        column: x => x.RewardId,
                        principalTable: "Rewards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientReward_ClientId",
                table: "ClientReward",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientReward_RewardId",
                table: "ClientReward",
                column: "RewardId");

            migrationBuilder.CreateIndex(
                name: "IX_InvestorReward_InvestorId",
